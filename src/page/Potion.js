...
const Potion = () => {
  const limit = [
    62.5, 60.68, 58.912, 57.196, 55.53, 53.913, 52.343, 50.818, 49.338, 47.901,
    21.625, 21.41, 21.198, 20.989, 20.781, 20.575, 20.371, 20.17, 19.97, 19.772,
    9.788, 9.691, 9.595, 9.5, 9.406, 4.657, 4.233, 3.848, 3.499, 3.181, 1.575,
    1.431, 1.301, 1.183, 1.075, 0.532, 0.484, 0.44, 0.4, 0.364, 0.18, 0.164,
    0.149, 0.135, 0.123, 0.061, 0.055, 0.005, 0.046, 0.03,
  ];

  const Typhoon = [
    62.5, 60.68, 58.912, 57.196, 55.53, 42.716, 41.472, 40.264, 39.091, 37.952,
    23.72, 23.029, 22.359, 21.707, 21.075, 20.461, 19.865, 19.287, 18.725,
    18.18, 8.207, 8.126, 8.045, 7.966, 7.887, 7.809, 7.731, 7.655, 7.579, 7.504,
    3.715, 3.678, 3.642, 3.606, 3.57, 1.767, 1.607, 1.461, 1.328, 1.207, 0.598,
    0.543, 0.494, 0.449, 0.408, 0.202, 0.184, 0.167, 0.152, 0.138, 0.068, 0.062,
    0.056, 0.051, 0.047, 0.023, 0.021, 0.019, 0.017, 0.012,
  ];
